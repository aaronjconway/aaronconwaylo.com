...
Read - [**How to Pick the Right Loan Officer**](choosing-a-loan-officer)

May I ask? 

* Do you tie your shoes before you put them on? 
* Do you pour the milk <i>then</i> put in the cereal? - <small>I will call the police</small>
...
Everyone opts for certainty. Anything else is chaos. Start with getting approved.   

Questions on the meaning of "qualified" or "approved". 

Read - [**Pre-Qualified, Pre-approved? Verified? What are these?**](types-of-approval-letters)

### Common Objections to Getting Qualified

* Rate Shopping at the pre approval stage. 
...
have to use it to apply for financing. It is better to know than to guess. 

Read - [**Everything About Credit**](credit)
...
**<u>There is still some ambiguity</u>** on the exact monthly payment and out of pocket expense. Your LO can't predict the future.
Everything should be roughly within 10% of the final numbers. I would also error on the side that final numbers will be 
higher and not lower. 

Some lenders, myself included, have a lock-and-shop option but it doesn't always
make sense and even then, with tax and insurance varying per home, I can't be dollar accurate. 
...
:::important
Make sure to notify your Lender ***BEFORE*** you submit an offer. 
Your LO and your Agent are a nice little trifecta that need to be working together for success.
:::

## Step 3 - Place the Offer

To reiterate, before you place and offer make sure you review the property with your LO.
...
TODO
Read - How to make a good offer ( Written by an Experienced Realtor )
...
With a specific home in mind, program selected and a short time frame, the Lender should be able to provide you with 
, not perfect, but more accurate numbers. 
...
This doesn't mean you should never switch lenders but at this stage you should have one you trust. 

## Step 4 - Offer accepted: Underwriting

Amazing! You are now under contract to purchase this home. 

There are many things that need to happen during this time and it's critically important you complete tasks asap. 
Don't be overwhelmed, with a good team you've chosen, you will
be hand-held through this process.

Let's get to it!

1. The lender needs to know the offer was accepted. Sometimes the realtors forget. 
2. Complete the remainder of the loan application with the LO. This includes:

    * Sign the required disclosures. 
    * Provide any other documentation needed for underwriting.
    * Lock the interest rate for the next 30+ days while going toward closing.
    * The lender will then submit the application to underwriting. 


3. The [**appraisal**](/docs/dictionary/appraisal) order will be placed by your loan officer. Depending on the company 
you may or may not pay for it all up front. It will be credited towards your closing costs either way.

:::tip
Appraisals can take anywhere from 2 to 30 days. It's important to work with your loan officer to get it ordered asap.  
:::

4. Order a home [**inspection**](/docs/dictionary/inspection). Your realtor should be able to assist with this. 

5. Deliver a check or wire the Earnest Money to title.
